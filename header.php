            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="cartridge_repair.php">Восстановление</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="printers_repair.php">Ремонт принтеров</a>
                </div>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="#">Принтеры</a>
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#">Тонеры</a>
                </div>
              </li> 
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="#">Запчасти 2</a>
                </div>
              </li>
